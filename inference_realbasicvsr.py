...
#python inference_realbasicvsr.py configs/realbasicvsr_x4.py checkpoint/RealBasicVSR_x4.pth data/demo_001.mp4 results/demo_001.mp4 --fps=12.5
# 480*640 17*30 x
# 480*360 30   20s  8s
# 480*360 4*25  30s
# 640*480 100   72s
...
def parse_args():
    ...
    parser.add_argument('--input_dir',type=str,default='data/043_20', help='directory of the input video')
    parser.add_argument('--output_dir',type=str,default='results/043_20', help='directory of the output video')
    parser.add_argument(
        '--max_seq_len',
        type=int,
        default=None,
